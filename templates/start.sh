...
sudo cp /home/gfb/index-wp-redis.php /home/gfb/app/wp/index-wp-redis.php;
sudo cp /home/gfb/index.php /home/gfb/app/wp/index.php;
...
do
    eval value=\$$name;
    sudo sed -i "s|\${${name}}|${value}|g" /home/gfb/app/wp/wp-config.php;
done

for name in REDIS_PORT_6379_TCP_ADDR WP_HOST_IP
do
    eval value=\$$name;
    sudo sed -i "s|\${${name}}|${value}|g" /home/gfb/app/wp/index-wp-redis.php;
done
