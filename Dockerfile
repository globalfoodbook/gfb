...
ENV NUT_API_IP=${LOCAL_HOST_IP} NUT_API_IP_PORT=${NUT_API_IP}:${NUT_API_PORT} HOME=/home/${MY_USER} PHP_FPM_CONF=${PHP_FPM_PATH}/php-fpm.conf PHP_FPM_POOL_CONF=${PHP_FPM_PATH}/pool.d/www.conf PHP_FPM_INI=${PHP_FPM_PATH}/php.ini PHP_FPM_IP=${LOCAL_HOST_IP}

ENV NUT_API_URL="http://${NUT_API_IP_PORT}/v1/nutrition/facts?ingredients=" APP_HOME=${HOME}/app
